...
{
	// Instanzvariable für den GUIScreener bereitstellen:
	...
	// ArrayList der Spiele-Namen für den Screener bereitstellen:
	...
	{ 
		...
		// Eigene Instanz and GUIScreener übergeben 
		// ( zur späteren Steuerung der GUIScreener-Events in der GameBuilder (MVC) ):
	...
	// Ein Spiele-Package hinzufügen ( wird in der Klasse BWVGame aufgerufen ):
	...
	public void executeGame( Integer i )
	{
		...
		// Spielinstanz aus ArryList holen und ausführen ( realisiert als Strategy-Pattern ):
		game.execute();
	}
